...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_voyager(
    KC_ESCAPE,      KC_TRANSPARENT, KC_TRANSPARENT, MAC_SIRI,       KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    ...
    KC_LEFT_GUI,    KC_Z,           KC_X,           LT(5, KC_C),    ALL_T(KC_D),    KC_V,                                           KC_K,           ALL_T(KC_H),    LT(2, KC_COMMA),KC_DOT,         KC_SLASH,       CW_TOGG,        
                                                    LT(4, KC_ENTER),LT(3, KC_TAB),                                  OSL(6),         LT(1, KC_SPACE)
  ),
  [1] = LAYOUT_voyager(
    ...
    ST_MACRO_1,     LALT(LCTL(LSFT(KC_S))),LALT(LCTL(LSFT(KC_T))),LALT(LCTL(LSFT(KC_P))),LALT(LCTL(LSFT(KC_F))),KC_TRANSPARENT,                                 KC_TRANSPARENT, LGUI(KC_LBRC),  KC_UP,          RGUI(KC_RBRC),  KC_TRANSPARENT, KC_TRANSPARENT, 
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, ST_MACRO_2,     KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, LCTL(LSFT(KC_TAB)),KC_TRANSPARENT, LCTL(KC_TAB),   KC_TRANSPARENT, KC_TRANSPARENT, 
  ...
  [6] = LAYOUT_voyager(
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_GRAVE,       KC_TILD,        KC_HASH,        KC_AMPR,        KC_PIPE,                                        KC_CIRC,        KC_LBRC,        KC_RBRC,        KC_LCBR,        KC_RCBR,        KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_EXLM,        KC_UNDS,        KC_COLN,        KC_EQUAL,       KC_DQUO,                                        KC_AT,          KC_LPRN,        KC_RPRN,        KC_UNDS,        KC_SCLN,        KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_PERC,        KC_QUES,        KC_ASTR,        KC_PLUS,        KC_BSLS,                                        KC_SLASH,       KC_MINUS,       KC_LABK,        KC_RABK,        KC_DLR,         KC_TRANSPARENT, 
                                                    KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT
  ),
};
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
  ...
  switch (keycode) {
    ...
    case ST_MACRO_1:
    if (record->event.pressed) {
      SEND_STRING(SS_TAP(X_GRAVE)SS_DELAY(10)  SS_TAP(X_GRAVE)SS_DELAY(10)  SS_TAP(X_GRAVE)SS_DELAY(10)  SS_RSFT(SS_TAP(X_ENTER))SS_DELAY(10)  SS_RSFT(SS_TAP(X_ENTER))SS_DELAY(10)  SS_TAP(X_GRAVE)SS_DELAY(10)  SS_TAP(X_GRAVE)SS_DELAY(10)  SS_TAP(X_GRAVE)SS_DELAY(10)  SS_TAP(X_UP));
    }
    break;
    case ST_MACRO_2:
    if (record->event.pressed) {
