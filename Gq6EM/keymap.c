...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_voyager(
    ...
    KC_LEFT_GUI,    KC_Z,           KC_X,           KC_C,           ALL_T(KC_D),    KC_V,                                           KC_K,           ALL_T(KC_H),    KC_COMMA,       KC_DOT,         KC_SLASH,       CW_TOGG,        
                                                    LT(2,KC_ENTER), LT(4,KC_TAB),                                   LT(3,KC_BSPC),  LT(1,KC_SPACE)
  ),
  [1] = LAYOUT_voyager(
  ...
  [4] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, KC_EXLM,        KC_AT,          KC_HASH,        KC_LBRC,        KC_RBRC,                                        KC_MINUS,       KC_1,           KC_2,           KC_3,           KC_SLASH,       KC_F12,         
    KC_TRANSPARENT, KC_CIRC,        KC_AMPR,        KC_ASTR,        KC_LPRN,        KC_RPRN,                                        KC_PLUS,        KC_4,           KC_5,           KC_6,           KC_ASTR,        KC_BSPC,        
    KC_TRANSPARENT, KC_TRANSPARENT, KC_DLR,         KC_PERC,        KC_LCBR,        KC_RCBR,                                        KC_DOT,         KC_7,           KC_8,           KC_9,           KC_EQUAL,       KC_ENTER,       
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
  switch (keycode) {
    ...
    case ST_MACRO_1:
    if (record->event.pressed) {
      SEND_STRING(SS_TAP(X_C)SS_DELAY(10)  SS_TAP(X_D)SS_DELAY(10)  SS_TAP(X_SPACE)SS_DELAY(10)  SS_TAP(X_NONUS_HASH)SS_DELAY(10)  SS_TAP(X_SLASH)SS_DELAY(10)  SS_TAP(X_C)SS_DELAY(10)  SS_TAP(X_O)SS_DELAY(10)  SS_TAP(X_D)SS_DELAY(10)  SS_TAP(X_E)SS_DELAY(10)  SS_TAP(X_SLASH));
    }
    break;
    case MAC_LOCK:
      HCS(0x19E);
