...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
  switch (keycode) {
    ...
    case ST_MACRO_1:
    if (record->event.pressed) {
      SEND_STRING(SS_TAP(X_GRAVE)SS_DELAY(10)  SS_TAP(X_GRAVE)SS_DELAY(10)  SS_TAP(X_GRAVE)SS_DELAY(10)  SS_TAP(X_ENTER)SS_DELAY(10)  SS_TAP(X_ENTER)SS_DELAY(10)  SS_TAP(X_GRAVE)SS_DELAY(10)  SS_TAP(X_GRAVE)SS_DELAY(10)  SS_TAP(X_GRAVE)SS_DELAY(10)  SS_TAP(X_UP));
    }
    break;
    case ST_MACRO_2:
    if (record->event.pressed) {
