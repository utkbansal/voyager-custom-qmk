...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, LALT(LGUI(LCTL(LSFT(KC_S)))),LALT(LCTL(LSFT(KC_T))),LALT(LCTL(LSFT(KC_P))),LALT(LCTL(LSFT(KC_F))),KC_TRANSPARENT,                                 KC_TRANSPARENT, LGUI(KC_LBRC),  KC_UP,          RGUI(KC_RBRC),  KC_TRANSPARENT, KC_TRANSPARENT, 
