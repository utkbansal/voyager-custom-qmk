...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_voyager(
    ...
    KC_BSPC,        MT(MOD_LCTL, KC_A),MT(MOD_LALT, KC_R),MT(MOD_LGUI, KC_S),MT(MOD_LSFT, KC_T),ALL_T(KC_D),                                    ALL_T(KC_H),    MT(MOD_RSFT, KC_N),MT(MOD_RGUI, KC_E),MT(MOD_RALT, KC_I),MT(MOD_RCTL, KC_O),KC_QUOTE,       
    CW_TOGG,        KC_Z,           KC_X,           KC_C,           KC_V,           KC_B,                                           KC_K,           KC_M,           KC_COMMA,       KC_DOT,         KC_SLASH,       TG(1),          
                                                    LT(2,KC_ENTER), MT(MOD_LCTL, KC_TAB),                                LT(4,KC_BSPC),  LT(3,KC_SPACE)
  ),
  [1] = LAYOUT_voyager(
  ...
  [3] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, LALT(LCTL(LSFT(KC_T))),LALT(LCTL(LSFT(KC_P))),LALT(LCTL(LSFT(KC_F))),KC_TRANSPARENT,                                 KC_PAGE_UP,     LGUI(KC_LBRC),  KC_UP,          RGUI(KC_RBRC),  KC_TRANSPARENT, KC_TRANSPARENT, 
